...
//            if charFormatString == String.ANYONE_CHAR || charFormatString == String.ANYONE_CHAR_UPPER {
//                stringToAdd = charString
//                counter += 1
//            } else if charFormatString == String.ONLY_CHAR_UPPER || charFormatString == String.ONLY_CHAR {
//                counter += 1
//                if charStringUpper.isChar() {
//                    stringToAdd = charStringUpper
//                }
//            } else if charFormatStringUpper == String.ONLY_NUMBER_UPPER ||
//                        charFormatStringUpper == String.ONLY_NUMBER {
//                counter += 1
...
//
//            if undefineChars.contains(changedCharString) {
//                var i = changeCharIndex - 1
//                while i >= 0 {
//                    if !undefineChars.contains(oldString[i]) {
...
//        return regexControlString(pattern: "[a-zA-Z]")
//    }
//
